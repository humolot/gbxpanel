...
- **Database:** MySQL databases whose name and user start with a prefix unique to the client (`<username><id>_`), so a client can never take over another database user; connection details, password, delete.
